...
def bin_authors(author_list:list[str]) -> tuple[list[str], ...]:
    """Makes bins of 7 authors given an iterable"""
    return tuple(chunked(author_list, 7))       
...
def main():
    ...
    bin_labels_sorted_by_docfreq = bin_authors(train_authors_sorted_by_docfreq)
